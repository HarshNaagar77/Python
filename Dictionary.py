...
print(person_profile)  # Output: {'name': 'Alice', 'age': 30, 'city': 'New  York', 'hobbies': ['reading', 'tr aveling', 'swimming'], 'is_student': False}

# Access a value by key 
print(person_profile['name'])  # Output: Aliceq56
...
# Get a value with a default if the key does not existw
...
print(inventory)  # Output: {'apples': 10, 'bananas': 8, 'oranges': 8, 'grapes': 12}m 
 
# List comprehension to create a new dictionary with items that have more than 6 in stoc k
